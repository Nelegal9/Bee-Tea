...
import com.alekhin.beetea.R.drawable.ic_settings_bluetooth
import com.alekhin.beetea.R.string.bluetooth
...
fun PermissionDialog(permanentlyDeclined: Boolean, onDismiss: () -> Unit, onOkClick: () -> Unit, onVisitAppSettingsClick: () -> Unit) {
    AlertDialog(
        ...
        icon = { Icon(painter = painterResource(id = ic_settings_bluetooth), contentDescription = stringResource(bluetooth)) },
